 ...
 * Use the [KartEkleFragment.newInstance] factory method to
...
class KartEkleFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (activity as BaseActivity).changeToolbarIconAndTitle("Kart Ekle", R.drawable.toolbar_back_icon)
        arguments?.let {
    ...
    companion object {
         ...
         * @return A new instance of fragment KartEkleFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KartEkleFragment().apply {
