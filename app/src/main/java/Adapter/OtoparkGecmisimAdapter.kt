...
class OtoparkGecmisimAdapter(private val otoparkGecmisimList: List<String>) :
    RecyclerView.Adapter<Adapter.OtoparkGecmisimAdapter.PlateViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlateViewHolder {
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.history_auto_park_list_item, parent, false)
