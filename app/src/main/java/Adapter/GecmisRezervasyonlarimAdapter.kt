...
class GecmisRezervasyonlarimAdapter(private val gecmisRezervasyonlarimList: List<String>) :
    RecyclerView.Adapter<Adapter.GecmisRezervasyonlarimAdapter.PlateViewHolder>() {
